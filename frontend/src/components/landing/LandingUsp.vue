    ...
    <div>
        <div class="px-4 py-16 md:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-3 fade-up">See Connections That <br></br> Others Might Miss</h2>
                <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto fade-up stagger-1">
                    Our AI acts as your early-warning system, connecting seemingly unrelated news to your specific holdings.
                </p>
            </div>
