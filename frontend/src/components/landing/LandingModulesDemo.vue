...
import StockPreviewModal from './StockPreviewModal.vue'; // Added Import

const hoveredModule = ref(null);
const isModalVisible = ref(false); // Added for modal
const selectedStock = ref({});   // Added for modal

// Demo modules data, with chart data added for the modal
const demoModules = ref([
    {
        ...
        chart: [180, 185, 182, 188, 192, 195] // Data for modal
    },
    {
        symbol: 'BTC',
        name: 'Bitcoin',
        ...
        chart: [42000, 42500, 41800, 43000, 43500, 43250] // Data for modal
    },
    {
        symbol: 'TSLA',
        name: 'Tesla Inc.',
        ...
        chart: [220, 225, 230, 228, 235, 238] // Data for modal
    }
]);
