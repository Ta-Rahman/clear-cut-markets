import{r as h,o as N,w as ht,B as j,a as bt,R as yt,z as st,v as C,C as L,h as Q,O as xt,W as wt,k as $t,$ as _t,x as ot,U as J,T as kt,b as Et,Y as St,Q as M,s as R,c as at,d as pt,_ as T,e as Tt,f as m,g as a,i as p,j as I,u as v,l as G,m as c,n as Ct,p as Lt,q as K,t as V,y as Mt,A as It,D as _,E as k,F as f,G as $,H as x,I as S,J as F,K as Pt,L as H,M as At,N as u,P as A,S as zt,V as X,X as tt,Z as ut,a0 as P}from"./index-D9i-74lr.js";import{C as Bt,s as Ot}from"./index-BxgtnGXw.js";import{s as y}from"./index-GylW5VaJ.js";import{s as Dt,a as jt}from"./index-BinnJiPT.js";function Ht(){const n=h(!1),t=()=>{const o=localStorage.getItem("theme");o?n.value=o==="dark":n.value=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,e()},e=()=>{const o=document.documentElement;n.value?o.classList.add("p-dark"):o.classList.remove("p-dark")},s=()=>{n.value=!n.value,localStorage.setItem("theme",n.value?"dark":"light"),e()};return N(()=>{window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",i=>{localStorage.getItem("theme")||(n.value=i.matches,e())})}),ht(n,e),{isDarkMode:n,toggleDarkMode:s,initDarkMode:t}}var Rt=`
    .p-tooltip {
        position: absolute;
        display: none;
